...
def tick(data, regs):
    ...
    if op == 1:
        ...
        set(data, i + 1, imm1, rel_base, int(input("IntMachine Input: ")))
        i += 2
    elif op == 4:
        print("IntMachine Output: {}".format(get(data, i + 1, imm1, rel_base)))
        i += 2
    elif op == 5:
